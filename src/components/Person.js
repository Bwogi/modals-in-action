		...
		<div className='px-4 py-5 text-center sm:px-6 rounded-md bg-gradient-to-r from-white to-gray-500 ... my-[50px] mx-[100px] drop-shadow-3xl'>
			<div className='flex space-x-3'>
				<div className='flex-shrink-0'>
					...
					<img className='h-10 w-10 rounded-full' src='https://images.unsplash.com/photo-1649057349440-38c14e985208?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjN8fHByb2ZpbGUlMjBwaWN0dXJlJTIwYm95fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=900&q=60' alt='' />
				</div>
